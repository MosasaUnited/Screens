...
class MySpaceSystem {
  ...
  static final double spaceX1 =
      double.parse((spaceX * _goldenRatio).toStringAsFixed(2));

  /// 10.47 px SpaceX2 by Golden-Ratio
  static final double spaceX2 =
      double.parse((spaceX1 * _goldenRatio).toStringAsFixed(2));

  /// 16.94 px SpaceX3 by Golden-Ratio
  static final double spaceX3 =
      double.parse((spaceX2 * _goldenRatio).toStringAsFixed(2));

  /// 27.41 px SpaceX4 by Golden-Ratio
  static final double spaceX4 =
      double.parse((spaceX3 * _goldenRatio).toStringAsFixed(2));

  /// 44.35 px SpaceX5 by Golden-Ratio
  static final double spaceX5 =
      double.parse((spaceX4 * _goldenRatio).toStringAsFixed(2));

  /// 71.76 px SpaceX6 by Golden-Ratio
  static final double spaceX6 =
      double.parse((spaceX5 * _goldenRatio).toStringAsFixed(2));

  /// 116.11 px SpaceX7 by Golden-Ratio
  static final double spaceX7 =
      double.parse((spaceX6 * _goldenRatio).toStringAsFixed(2));

  /// 187.87 px SpaceX8 by Golden-Ratio
  static final double spaceX8 =
      double.parse((spaceX7 * _goldenRatio).toStringAsFixed(2));
// }
